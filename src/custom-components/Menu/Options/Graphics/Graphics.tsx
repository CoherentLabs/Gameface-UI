    ...
    return (
        <Navigation.Area name="menu" selector="menu-item" focused>
            ...
            <MenuItem id="display" name='Display'>
                <CustomSegment id="display" values={['full screen', 'windowed', 'borderless' ]} default="full screen" />
            </MenuItem>
            <MenuItem id="brightness" name='Brightness'>
                <CustomSlider id="brightness" min={0} max={100} step={1} value={50} />
            </MenuItem>
            <MenuItem id="contrast" name='Contrast'>
                <CustomSlider id="contrast" min={0} max={100} step={1} value={50} />
            </MenuItem>
            <MenuItem id="crosshairColor" name='Crosshair color'>
                <ColorPreview id="crosshairColor" />
            </MenuItem>
            <MenuItem id="v-sync" name='V-sync'>
                <CustomCheckbox id="v-sync" checked />
            </MenuItem>
            <MenuItem id="hudOpacity" name='HUD Opacity'>
                <CustomNumberInput id="hudOpacity" min={0} max={100} value={100} />
            </MenuItem>
            <GraphicsPreset />
        </Navigation.Area>
    )
