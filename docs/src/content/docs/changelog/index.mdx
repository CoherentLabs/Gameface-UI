...
<Badge text="Feature" variant="success" size="small" /> [Modal](/components/basic/modal): added `onOpen` and `onClose` props.
...
<Badge text="New" variant="tip" size="small" /> Added [Modal](/components/basic/modal) component.

<Badge text="Feature" variant="success" size="small" /> Added `Overlay` and `Window` slots for the [Modal](/components/basic/modal#slots) component.
