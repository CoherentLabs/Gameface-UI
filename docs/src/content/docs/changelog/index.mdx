...
<Badge text="New" variant="tip" size="small" /> Added [Switch](/components/basic/switch) component.
...
<Badge text="Feature" variant="success" size="small" /> Added `LabelLeft`, `LabelRight`, `Handle`, `Control` and `Indicator` slots for the Switch component for easier customization.
