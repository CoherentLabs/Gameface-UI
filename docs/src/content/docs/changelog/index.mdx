...
- <Badge text="New" variant="tip" size="small" /> [RadialMenu](/components/complex/radial-menu) - Provide [a step by step guide](/components/complex/radial-menu/#opening-and-closing-the-menu) on how to enable navigation support for the component.
