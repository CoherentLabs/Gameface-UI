...
<Badge text="Feature" variant="success" size="small" /> Added `Carousel.Items`, `Carousel.Pagination`, `Carousel.Next`, `Carousel.Pev` components for the [Carousel](/components/complex/carousel#carousel-items) component.
