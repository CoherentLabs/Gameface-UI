...
The CLI pulls in whatever `SegmentedProgressBar` depends on. To refresh an existing copy, [update it](/docs/getting-started/updating-components) instead.
...
import { onMount } from 'solid-js'; // @hide
