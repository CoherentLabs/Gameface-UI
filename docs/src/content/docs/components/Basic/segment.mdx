...
:::caution
The indicator is responsible only for the moving part of the transition. To fully style the transition, you also need to apply styles to the `::before` pseudo element of the `Segment.Button`
:::
