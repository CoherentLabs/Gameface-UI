...
The `Grid` component must be used in tandem with the [GridTile](../grid-tile/) component, which allows for placement of content within specific grid cells.
...
:::tip
You can check more in-depth usage examples of the `Grid.Tile` slot in the [GridTile documentation](../grid-tile/#guide).
:::
