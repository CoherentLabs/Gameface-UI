...
Every component ships with the boilerplate. If you are working in your own project, add `Scroll` with the [Gameface CLI](https://frontend-tools.coherent-labs.com/gameface-cli/getting-started/):

```bash
npx gameface-cli add Scroll
```

The CLI pulls in whatever `Scroll` depends on. To refresh an existing copy, [update it](/docs/getting-started/updating-components) instead.
...
| ---------- | -------------------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `style`    | `JSX.CSSProperties`                    | `{}`        | Inline styles to apply directly to the scroll's wrapper element.                                                                                                                             |
...
To interact with the `Scroll` programmatically, you can use the `ScrollComponentRef` interface. This interface provides properties and methods to access and manipulate the component's state.

### Properties

| Property   | Type                | Description                                                                 |
|------------|---------------------|-----------------------------------------------------------------------------|
| `element`  | `HTMLDivElement`    | A reference to the scroll's root HTML element, useful for DOM access or styling. |
...
| `ref`  | `HTMLDivElement`  | `undefined`  | A reference to the scroll content wrapper HTML element, useful if you need to do custom calculations with the `scrollTop` or `scrollHeight` properties. |
...
<Scroll
    onAction={{
        'select': () => console.log('Custom select logic'), 
