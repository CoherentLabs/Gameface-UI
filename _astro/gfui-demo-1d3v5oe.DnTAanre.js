import { E as useContext, b as createMemo, g as getNextElement, i as insert, n as createRenderEffect, p as className, s as style, t as template, v as getNextMarker, c as createComponent, A as delegateEvents, a as createSignal, j as createEffect, k as on, o as onMount, u as use, w as Show, B as runHydrationEvents, D as createContext, r as render } from './web.BgHhn69X.js';
import { c as createTokenComponent, u as useToken } from './tokenComponents.DvO1PJlV.js';
import { n as navigationActions, b as baseComponent } from './BaseComponent.DR8Y59bT.js';
import { m as mergeNavigationActions } from './mergeNavigationActions.C3r_vRJZ.js';
import './store.DVrtUaE7.js';

const control = "_control_1129p_7";
const disabled = "_disabled_1129p_22";
const handle = "_handle_1129p_29";
const indicator = "_indicator_1129p_32";
const styles = {
	"toggle-button": "_toggle-button_1129p_1",
	control: control,
	"label-left-enabled": "_label-left-enabled_1129p_15",
	"label-right-enabled": "_label-right-enabled_1129p_18",
	disabled: disabled,
	handle: handle,
	"indicator-checked": "_indicator-checked_1129p_32",
	indicator: indicator,
	"handle-checked": "_handle-checked_1129p_65"
};
