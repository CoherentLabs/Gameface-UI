import { g as getNextElement, u as use, E as setAttribute, t as template, b as createMemo, k as createEffect, l as on, e as batch, o as onMount, c as createComponent, D as createContext, z as delegateEvents, C as useContext, a as createSignal, i as insert, A as runHydrationEvents, r as render } from './web.ibFHgs_k.js';
import { c as createStore, u as unwrap } from './store.DBjQIIM3.js';
import { _ as __vite_glob_0_79 } from './round-star.DgGHujc5.js';
import { b as baseComponent, u as useNavigation, n as navigationActions } from './BaseComponent.DEyWe7lF.js';
import { GamepadMappings, gamepad } from 'coherent-gameface-interaction-manager';
...
const Keybinds = (props) => {
  ...
  const sanitizeButtonInput = (input) => {
    ...
    if (GamepadMappings.axisAliases.includes(button)) return button;
    const key = GamepadMappings.aliases[button];
