...
function setProperty(node, name, value) {
  ...
  if ((node.nodeName === "INPUT" || node.nodeName === "TEXTAREA")) node[name] = value ?? "";else node[name] = value;
}
...
export { $PROXY as $, delegateEvents as A, runHydrationEvents as B, setStyleProperty as C, setAttribute as D, createContext as E, For as F, useContext as G, spread as H, Switch as I, children as J, Dynamic as K, setProperty as L, Match as M, createRoot as N, Index as O, Portal as P, Suspense as S, createSignal as a, createMemo as b, createComponent as c, batch as d, $TRACK as e, getListener as f, getNextElement as g, hydrate as h, insert as i, createEffect as j, on as k, onCleanup as l, mergeProps as m, createRenderEffect as n, onMount as o, className as p, splitProps as q, render as r, style as s, template as t, use as u, getNextMarker as v, Show as w, createUniqueId as x, memo as y, addEventListener as z };
