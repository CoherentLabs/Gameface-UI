import { z as delegateEvents, C as useContext, o as onMount, n as onCleanup, g as getNextElement, v as getNextMarker, u as use, i as insert, c as createComponent, w as Show, p as createRenderEffect, E as setAttribute, q as className, s as style$1, A as runHydrationEvents, t as template, b as createMemo, F as For, m as mergeProps, H as spread, a as createSignal, k as createEffect, l as on, D as createContext, d as createUniqueId, r as render } from './web.ibFHgs_k.js';
...
import { n as navigationActions, u as useNavigation, b as baseComponent, w as waitForFrames } from './BaseComponent.DEyWe7lF.js';
...
const wf44qo = (root) => render(() => createComponent(Dropdown$1, {
  get children() {
    return createComponent(Dropdown$1.Options, {
      get children() {
        return [createComponent(Dropdown$1.Option, {
          selected: true,
          value: "red",
          children: "red"
        }), createComponent(Dropdown$1.Option, {
          value: "green",
          children: "green"
        }), createComponent(Dropdown$1.Option, {
          value: "blue",
